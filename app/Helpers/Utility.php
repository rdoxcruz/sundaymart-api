...
class Utility
{
     ...
     * @return float|null
     */
    public function getScheduleOrderDeliveryPrice(Shop $shop, ?float $km, ?float $rate): ?float
    {
        $price      = $shop->price;
        $pricePerKm = $shop->price_per_km;
    ...
    /**
     * @param float|null $km
     * @param DeliveryOption|DeliveryOptionResource|null $deliveryOption
     * @param float|null $rate
     * @return float|null
     */
	public function getPriceByDistance(?float $km, DeliveryOption|DeliveryOptionResource|null $deliveryOption, ?float $rate): ?float
	{
		$price      = $deliveryOption?->price;
		$pricePerKm = $deliveryOption?->price_per_km;
