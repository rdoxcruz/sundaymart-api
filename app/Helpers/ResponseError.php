...
class ResponseError
{
    ...
    public const ERROR_120 = 'ERROR_120'; // 'Cant create auto order on pastime'
    ...
    public const ERROR_218 = 'ERROR_218'; // 'your email is not valid'
    ...
    public const ERROR_441 = 'ERROR_441'; // 'Your referral expired'
