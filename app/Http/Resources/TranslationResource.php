...
class TranslationResource extends JsonResource
{
    ...
    {
        /**
         * @var ShopTranslation|FaqTranslation|ReferralTranslation|BlogTranslation|BannerTranslation|ProductTranslation|JsonResource $this
         */
        return [
            'id'            => $this->id,
            'locale'        => $this->locale,
            ...
            'ingredients'   => $this->when($this->ingredients, $this->ingredients),
