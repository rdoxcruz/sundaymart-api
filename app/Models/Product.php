 ...
 * @property double $r_avg
 * @property double $r_count
 * @property double $o_count
 * @property double $od_count
 * @property double $age_limit
 * @property double $expiration_date
 * @property-read double $distance
 ...
 * @method static Builder|Product actual($lang)
...
class Product extends Model
{
    ...
    public function scopeFilter($query, $array)
    {
        ...
        $query
            ...
            ->when(data_get($array, 'expiration_date_from'), function (Builder $query, $dateFrom) use ($array) {

                $dateFrom = date('Y-m-d', strtotime($dateFrom));
                $dateTo = data_get($array, 'expiration_date_to', $dateFrom);

                $query->where([
                    ['expiration_date', '>=', $dateFrom],
                    ['expiration_date', '<=', $dateTo],
                ]);
            })
            ...
            ->when(data_get($array, 'shop_status'), function ($q, $status) {
            ...
            ->when(data_get($array, 'rating'), function (Builder $q, $rating) {
