...
<div class="container d-flex justify-content-between" style="margin-top: 100px">
    <div class="float-left" style="margin-right: 50px">
        <h3 class="subtitle">{{ __('errors.' . ResponseError::ADDRESS, locale: $lang) }}</h3>
...
<table class="table table-striped mt-4 table-bordered">
    ...
    <tr>
        ...
        <th scope="col">{{ __('errors.' . ResponseError::PRICE, locale: $lang) }} {{ $order->currency?->symbol }}</th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <th scope="col">{{ __('errors.' . ResponseError::PRICE, locale: $lang) }} {{ $order->currency?->symbol }}</th>
        <th scope="col">{{ __('errors.' . ResponseError::TOTAL_PRICE, locale: $lang) }} {{ $order->currency?->symbol }}</th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<div class="container float-left">
    <p><b>{{ __('errors.' . ResponseError::DELIVERY_DATE, locale: $lang) }}:</b> {{ $order->delivery_date }}</p>
</div>
