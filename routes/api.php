...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        Route::get('products/{id}/reviews-group-rating', [Rest\ProductController::class, 'reviewsGroupByRating'])
            ->where('id', '[0-9]+');
        Route::get('properties/{id}', [Rest\ProductController::class, 'propertiesByCategory'])
            ->where('id', '[0-9]+');
        ...
        Route::get('shops-histories/paginate',      [Rest\ShopController::class, 'history']);
		...
		Route::post('pay-fast-process', 		 [Payment\PayFastController::class, 	'orderProcessTransaction']);

		Route::apiResource('delivery-points',  Rest\DeliveryPointController::class)->only(['index', 'show']);
		Route::apiResource('delivery-options', Rest\DeliveryOptionController::class)->only(['index', 'show']);
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'seller', 'middleware' => ['sanctum.check', 'role:seller|moderator'], 'as' => 'seller.'], function () {
            ...
            Route::apiResource('delivery-options', Seller\DeliveryOptionController::class);
            Route::delete('delivery-options/delete', [Seller\DeliveryOptionController::class, 'destroy']);
		});
...
//            Route::get('extras/report/paginate',    [Admin\ProductController::class,   'extrasReportPaginate']);
            ...
            Route::apiResource('delivery-options', Admin\DeliveryOptionController::class);
            Route::delete('delivery-options/delete', [Admin\DeliveryOptionController::class, 'destroy']);
            Route::get('delivery-options/drop/all',  [Admin\DeliveryOptionController::class, 'dropAll']);
